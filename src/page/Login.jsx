...
//       userDetails,
//       (data, meta)=>{
//         localStorage.setItem("_dl_token", meta?.token);
//         // navigate('/entry')
//       },
...
//       <p className="text-sm text-blue-500 mb-4">Login to continue</p>

//       <div className="mb-4">
//         <label className="block text-sm font-medium text-gray-700">Email</label>
//         <div className="relative mt-1">
//           <FiMail className="absolute left-3 top-3 text-gray-400" />
//           <input onChange={handleChange} name="email" type="email" placeholder="support@freeslab.com" className="w-full border rounded-lg py-2 pl-10 pr-3 text-gray-700 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
//         </div>
//       </div>
...
//           <input onChange={handleChange} name="password" type="password" placeholder="••••••••" className="w-full border rounded-lg py-2 pl-10 pr-3 text-gray-700 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
//         </div>
//       </div>

//       <button onClick={handleSubmit} className="w-full bg-blue-600 text-white py-3 rounded-lg font-semibold mb-3 hover:bg-blue-700 transition-all">
...
//         Did you forget your password? <span className="text-blue-500">Reset here</span>
//       </p>
//     </form>
//   );
// }
