      ...
      socketRef.current.on("newMessage", (payload) => {
        const updatedConversations = allConversations.map((chat) =>
          chat.conversationId === payload.conversationId
            ? { ...chat, messages: [...chat.messages, payload.content] }
            : chat
        );
    ...
    <div className="flex h-full">
      ...
      <div className="flex-1 p-4 flex flex-col">
        ...
        <form
          ...
          className="mt-3 flex text-gray-800"
        >
          <input
            type="text"
            name="content"
          ...
          <button
            type="submit"
            className="p-2 bg-orange-500 text-white rounded-r-lg hover:bg-orange-600 transition-colors"
          >
            Send
          </button>
        </form>
